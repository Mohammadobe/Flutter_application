...
class appPage13 extends StatefulWidget{

  @override
  _appPage13State createState() => _appPage13State();

}

class _appPage13State extends State<appPage13> {
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: IconButton(
                        onPressed: (){}, 
                        icon: Icon(Icons.check_circle , size: 28 , color: Color.fromRGBO(200, 199, 204, 1),)
                      ),
                    ),
